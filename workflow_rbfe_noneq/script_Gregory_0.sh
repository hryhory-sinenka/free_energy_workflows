...
cp Lysozyme/${s0}_complex/gromacs/toppar/${ligand_0}.itp ${state}/${s0}/pmx/MOL.itp
cp Lysozyme/${s0}_complex/gromacs/toppar/forcefield.itp ${state}/${s0}/pmx/forcefield.prm
gmx_mpi editconf -f Lysozyme/${s0}_complex/gromacs/step4.1_equilibration.gro -o Lysozyme/${s0}_complex/gromacs/step4.1_equilibration.pdb
cat Lysozyme/${s0}_complex/gromacs/step4.1_equilibration.pdb | grep ${ligand_0} > ${state}/${s0}/pmx/${s0}.pdb
sed -i "s/${ligand_0}/MOL/g" "${state}/${s0}/pmx/${s0}.pdb"
sed -i "s/${ligand_0}/MOL/g" "${state}/${s0}/pmx/MOL.itp"
cp Lysozyme/${s0}_complex/gromacs/step5_production.trr ${state}/${s0}/step5_production.trr
cp Lysozyme/${s0}_complex/gromacs/step5_production.tpr ${state}/${s0}/step5_production.tpr
cp -r Lysozyme/${s0}_complex/gromacs/toppar ${state}/toppar_${s0}
cp -r Lysozyme/${s0}_complex/gromacs/topol.top ${state}/topol_${s0}-${s1}.top


cp Lysozyme/${s1}_complex/gromacs/toppar/${ligand_1}.itp ${state}/${s1}/pmx/MOL.itp
cp Lysozyme/${s1}_complex/gromacs/toppar/forcefield.itp ${state}/${s1}/pmx/forcefield.prm
gmx_mpi editconf -f Lysozyme/${s1}_complex/gromacs/step4.1_equilibration.gro -o Lysozyme/${s1}_complex/gromacs/step4.1_equilibration.pdb
cat Lysozyme/${s1}_complex/gromacs/step4.1_equilibration.pdb | grep ${ligand_1} > ${state}/${s1}/pmx/${s1}.pdb
sed -i "s/${ligand_1}/MOL/g" "${state}/${s1}/pmx/${s1}.pdb"
sed -i "s/${ligand_1}/MOL/g" "${state}/${s1}/pmx/MOL.itp"
cp Lysozyme/${s1}_complex/gromacs/step5_production.trr ${state}/${s1}/step5_production.trr
cp Lysozyme/${s1}_complex/gromacs/step5_production.tpr ${state}/${s1}/step5_production.tpr
cp -r Lysozyme/${s1}_complex/gromacs/toppar ${state}/toppar_${s1}
cp -r Lysozyme/${s1}_complex/gromacs/topol.top ${state}/topol_${s1}-${s0}.top
...
sed -i "s#$old_path/PROA.itp#$new_path/PROA.itp#g" $state/topol_${s0}-${s1}.top
