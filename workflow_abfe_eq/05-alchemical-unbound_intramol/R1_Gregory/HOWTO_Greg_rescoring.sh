...
cp ${prev}/topol.top ./
cp ${prev}/prod.gro init.gro
cp ${prev}/prod.cpt init.cpt

#..RETRIEVE files 
#cp -rp ${prev}/toppar ./
#cp ${prev}/topol.top ./
#cp ${prev}/index.ndx ./
#cp ${prev}/step5_production.cpt prod.cpt
#cp ${prev}/step5_production.gro prod.gro
#cp ${prev}/step5_production.tpr prod.tpr
#cp ${prev}/plumed.dat ./
#cp ${prev}/*.pdb ./
...
#gmx_mpi grompp -f step4.1_equilibration_1.mdp -c min_2.gro -r init.gro -p $itop -o equil_1.tpr -maxwarn 2
#srun gmx_mpi mdrun -deffnm equil_1 -v -ntomp $SLURM_CPUS_PER_TASK -pin on -pinoffset 0

#gmx_mpi grompp -f step4.1_equilibration_2.mdp -c equil_1.gro -t equil_1.cpt -r init.gro -p $itop -o equil_2.tpr -maxwarn 2
#srun gmx_mpi mdrun -deffnm equil_2 -v -ntomp $SLURM_CPUS_PER_TASK -pin on -pinoffset 0

#gmx_mpi grompp -f step4.1_equilibration_3.mdp -c equil_2.gro -t equil_2.cpt -r init.gro -p $itop -o equil_3.tpr -maxwarn 2
#srun gmx_mpi mdrun -deffnm equil_3 -v -ntomp $SLURM_CPUS_PER_TASK -pin on -pinoffset 0

#gmx_mpi grompp -f step4.1_equilibration_4.mdp -c equil_3.gro -t equil_3.cpt -r init.gro -p $itop -o equil_4.tpr -maxwarn 2
#srun gmx_mpi mdrun -deffnm equil_4 -v -ntomp $SLURM_CPUS_PER_TASK -pin on -pinoffset 0

gmx_mpi grompp -f PROD.mdp -c init.gro -t init.cpt -p $itop -o alch.tpr -maxwarn 2
